...
cumcoeff_summary <- readRDS(here("source_data", "cumcoeff_summary.rds"))
...
#print LaTeX table
print(xtable(bin_table, digits = 5), file = here("tables_plots", "bin_table.tex"), booktabs = TRUE, include.rownames = FALSE)

#print LaTeX table for the cumulative lag coefficients of the three primary models
print(xtable(cumcoeff_summary, digits = 5), file = here("tables_plots", "cumcoeff_summary.tex"), booktabs = TRUE, include.rownames = FALSE)
